...
#define XF_CMSIS_THREAD_DELETE_NULL_BASE_ON_TERMINATE_ENABLE CONFIG_XF_CMSIS_THREAD_DELETE_NULL_BASE_ON_TERMINATE_ENABLE

#define XF_CMSIS_THREAD_GET_COUNT_ENABLE CONFIG_XF_CMSIS_THREAD_GET_COUNT_ENABLE

#define XF_CMSIS_THREAD_ENUMERATE_ENABLE CONFIG_XF_CMSIS_THREAD_ENUMERATE_ENABLE
