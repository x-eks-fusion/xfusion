...
enum {
    ...
    HID_INFORMATION_PROPERTIES   = XF_BLE_GATT_CHARA_PROPERTY_READ,
    /* HID protocol mode characteristic properties */
    HID_PROTOCOL_MODE_PROPERTIES = XF_BLE_GATT_CHARA_PROPERTY_READ | XF_BLE_GATT_CHARA_PROPERTY_WRITE_NO_RSP,
    /* HID report map characteristic properties */
    HID_REPORT_MAP_PROPERTIES    = XF_BLE_GATT_CHARA_PROPERTY_READ,
    /* HID input report characteristic properties */
    HID_INPUT_REPORT_PROPERTIES  = XF_BLE_GATT_CHARA_PROPERTY_READ | XF_BLE_GATT_CHARA_PROPERTY_NOTIFY |
                                   XF_BLE_GATT_CHARA_PROPERTY_WRITE,
    /* HID output report characteristic properties */
    HID_OUTPUT_REPORT_PROPERTIES = XF_BLE_GATT_CHARA_PROPERTY_READ | XF_BLE_GATT_CHARA_PROPERTY_WRITE |
                                   XF_BLE_GATT_CHARA_PROPERTY_WRITE_NO_RSP,
    /* HID control point characteristic properties */
    HID_CONTROL_POINT_PROPERTIES = XF_BLE_GATT_CHARA_PROPERTY_WRITE_NO_RSP,
};
